window.document.addEventListener("DOMContentLoaded", function (event) {
  var roomHtml = "<span class='subtitle'>Weds 6:30-9pm, Car Barn 204</span>";
  var termHtml = "<span class='subtitle'>Georgetown Fall 2024</span>";
  var emailHtml = "<span class='subtitle w-100'>Prof. Jeff Jacobs&nbsp;<a href='mailto:jj1088@georgetown.edu' target='_blank'><i class='bi bi-envelope-at ps-1 pe-1'></i></a></span>";
  ...
  var zoomHtml = `<div class='subtitle btn btn-outline-dark btn-block mt-2 mx-0 px-2 w-100 d-flex justify-content-center'><a href='https://georgetown.zoom.us/j/94074713027' target='_blank' class='icon-link' style='text-decoration: none !important;'><span class='icon ps-0'>${zoomIconBlue}</span><span class='flex-grow-1'>Zoom Link</span><i class='bi bi-box-arrow-up-right pe-1 ps-1 me-1' style='font-size: 85%;'></i></a></div>`;
