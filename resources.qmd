...
**Ward and Gleditsch, *An Introduction to Spatial Regression Models in the Social Sciences*** [[`pdf`](https://www.dropbox.com/scl/fi/dr3cwrjaoiis1bkq858na/W4_W7_WardGleditsch.pdf?rlkey=5xg4rxvvzylhjwv4hdc2vop03&dl=1)]
...
* **Lessons 1 through 11 of [Norm Matloff's "FasteR" R tutorial](https://github.com/matloff/fasteR)** will walk you gently through the basic syntax, data structures, and functions in "base" R that we'll build upon as the course progresses!
