...
**Baddeley, Rubak, and Turner, *Spatial Point Patterns: Methodology and Applications with R*** \[[`pdf`](https://www.dropbox.com/scl/fi/egw826hopf6q53ll071n1/Baddeley-Adrian_-Rubak-Ege_-Turner-Rolf-Spatial-point-patterns.pdf?rlkey=y1n4smru4sj43sxzu4x54p5a9&dl=1)\]
...
**Waller and Gotway, *Applied Spatial Statistics for Public Health Data*** [[`pdf`](https://www.dropbox.com/scl/fi/kyq9h64e3x2zcd5qezaeh/Lance-A.-Waller-Carol-A.-Gotway-Applied-Spatial-Analysis-of-Public-Health-Data.pdf?rlkey=ajc3pfm3j01htkflidgd6jx28&dl=1)]
...
::::: {.callout-tip title="<i class='bi bi-4-circle'></i> The *Spatial Regression* Book: @ward_spatial_2018" icon="false" appearance="default"}

**Ward and Gleditsch, *An Introduction to Spatial Regression Models in the Social Sciences*** [[`pdf`](https://www.dropbox.com/scl/fi/1hxzqcn9e1a5fntw8iqvk/Spatial-Regression-Models.pdf?rlkey=edeow7y9l1l0c8e8xhq8nxldf&dl=1)]

:::: {layout="[30,70]" layout-valign="center"}
::: {#waller-cover style="margin-right: 8px;"}
![](images/ward_gleditsch.jpg){width="180"}
:::
::: {#waller-text}

This one is a new addition to the course, but feels like an important addition! Because, you _could_ "piece together" how to estimate spatial regression models from @baddeley_spatial_2015 and @waller_applied_2004 mentioned above (which is what students did in previous versions of the course), but this book packs a full-on self-contained guide to how these models work into only about **80 pages**. So, whereas the above books span many different topics in the course, consider this book to be a "companion guide" to **Homework 4** specifically 😎
...
* **Lessons 1 through 9 of [Norm Matloff's "FasteR" R tutorial](https://github.com/matloff/fasteR)** will walk you gently through the basic syntax, data structures, and functions in "base" R that we'll build upon as the course progresses!
...
* If you're looking to dive headfirst into more intensive statistical modeling of geospatial (and spatio**temporal**) data, definitely check out [Data Over Space and Time](https://www.stat.cmu.edu/~cshalizi/dst/20/){target='_blank'}, a course taught by Cosma Shalizi, a very cool professor of Statistics at Carnegie Mellon University.
