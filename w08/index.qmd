...
<tbody>
<tr>
  <td><span data-qmd="$N = 60$ Events"></span></td>
...
```{.r}
spatstat.random::rMaternI()
spatstat.random::rMaternII()
```

## Cox Processes: Random Points *plus* Random Intensity

[`rLGCP()`](https://search.r-project.org/CRAN/refmans/spatstat.random/html/rLGCP.html){target='_blank'}
