...
Welcome to the Fall 2024 version of **Geographic Information Systems** at Georgetown University!

::: {.callout-note title="Course Numbering"}

* For *Data Science and Analytics* students: the course number is **DSAN 6750**
* For *McCourt School of Public Policy* students: the course number is **PPOL 6805**
...
<tbody>
<tr>
    <td><span data-qmd="**Unit 1**: GIS Overview"></span></td>
    <td>1</td>
...
<tr>
    <td><span data-qmd="**Unit 2**: GIS APIs"></span></td>
    <td>4</td>
...
<tr>
    <td><span data-qmd="**Unit 4**: Datasets, Data Sharing, and Reproducible Science"></span></td>
    <td>12</td>
