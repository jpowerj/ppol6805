...
<tr>
    <td><span data-qmd="<i class='bi bi-arrow-return-right pe-1'></i>**HW5A**: {{< var hw.5.title >}}"></span></td>
    <td><span data-qmd="{{< var hw.5.pct >}}"></span></td>
</tr>
<tr>
    <td><span data-qmd="<i class='bi bi-arrow-return-right pe-1'></i>**HW5B**: {{< var hw.6.title >}}"></span></td>
    <td><span data-qmd="{{< var hw.6.pct >}}"></span></td>
</tr>
</tbody>
</table>
```
