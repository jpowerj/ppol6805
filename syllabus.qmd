...
<tr>
    ...
    <td><span data-qmd="[{{< var weeks.4.title >}}](./w04/)"></span><br><span data-qmd="*HW2 Release*"></span></td>
</tr>
<tr class='new-unit'>
    <td><span data-qmd="**Unit 3:** Mapping Libraries"></span></td>
    <td>5</td>
    <td><span data-qmd="{{< var weeks.5.date-md >}}"></span></td>
    <td><span data-qmd="[{{< var weeks.5.title >}}](./w05/)"></span><br><span data-qmd="*[Deliverable] HW2: {{< var hw.2.title >}}*"></span></td>
</tr>
<tr>
    <td></td>
    <td>6</td>
    <td><span data-qmd="{{< var weeks.6.date-md >}}"></span></td>
    <td><span data-qmd="[{{<var weeks.6.title >}}](./w06/)"></span><br><span data-qmd="*HW3 Release*"></span></td>
</tr>
<tr class='new-unit'>
    <td><span data-qmd="**Unit 4:** Spatial Data Science"></span></td>
    <td>7</td>
    <td><span data-qmd="{{< var weeks.7.date-md >}}"></span></td>
    <td><span data-qmd="[{{< var weeks.7.title >}}](./w07/)"></span><br><span data-qmd="*[Deliverable] HW3: {{< var hw.3.title >}}*"></span></td>
</tr>
<tr>
    <td></td>
    <td>8</td>
    <td><span data-qmd="{{< var weeks.8.date-md >}}"></span></td>
    <td><span data-qmd="[{{< var weeks.8.title >}}](./w08/)"></span><br><span data-qmd="*HW4 Release*"></span></td>
</tr>
<tr>
    <td></td>
    <td>9</td>
    <td><span data-qmd="{{< var weeks.9.date-md >}}"></span></td>
    <td><span data-qmd="[{{< var weeks.9.title >}}](./w09/)"></span><br><span data-qmd="*[Deliverable] HW4: {{< var hw.4.title >}}*"></span></td>
</tr>
<tr>
    <td></td>
    <td>10</td>
    <td><span data-qmd="{{< var weeks.10.date-md >}}"></span></td>
    <td><span data-qmd="[{{< var weeks.10.title >}}](./w10/)"></span><br><span data-qmd="*Midterm Practice Problems Release*"></span></td>
</tr>
<tr>
    <td></td>
    <td>11</td>
...
<tr class='new-unit'>
    <td><span data-qmd="**Unit 5**: Applications"></span></td>
    <td>12</td>
