...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><span data-qmd="1\. Amazing video introduction to analyzing spatial autocorrelation for *epidemiology* using R: @xie_analyzing_2022
  
  2\. Three 'core' spatial-statistical datatypes: @schabenberger_statistical_2004, Section 1.2: *Types of Spatial Data* (pgs. 6-13)
  
  3\. @baddeley_spatial_2015, Chapter 5: *Point Process Methods* (pgs. 127-154)</li></ol>"></span></td>
</tr>
<tr>
    <td></td> 
    <td>8</td>
...
<tr>
  <td></td>
  <td colspan="3" class="text-85" style="padding-top: 0px;"><span data-qmd="1\. Intensity Functions (First-order properties of point processes): @baddeley_spatial_2015, Chapter 6: *Intensity* (pgs. 157-198)

  2\. Pair Correlation Functions (Second-order properties of point processes): @baddeley_spatial_2015, Chapter 7: *Correlation* (pgs. 199-254)
  
  3\. Monte Carlo Simulation: @waller_applied_2004, Section 5.2.3: *Hypothesis Tests of CSR via Monte Carlo Methods* (pgs. 125-126*ff*)"></span></td>
</tr>
<tr class='new-unit'>
    <td>
