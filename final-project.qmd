...
Once we get to the Spatial Data Science unit, I'm hoping that you will have lots of inspiration in terms of the different methods that can be used for drawing **inferences** about spatial phenomena! Until then, the TAs and I will add links to the following [Raindrop.io collection](https://raindrop.io/jpowerj/gis-47891594){target='_blank'}, which you can browse to potentially draw inspiration for your own final project topic:
