---
title: "Week 9: {{< var weeks.8.title >}}"
...
#| crop: true
#| fig-width: 3
int_controls <- density(controls, sigma = bw)
...
#| crop: true
#| fig-width: 3
int_cases <- density(cases, sigma = bw)
...
* Approach: compare with two possible **null models**:
...
* Everyone in the population is **equally at risk** of contracting the disease, **regardless** of their spatial location
* Here, since we have 761 cases and 3020 controls, the estimated **constant risk** would be $\frac{761}{3020+761} \approx 0.201$:
...
gen_pbc_sim <- function() {
    pbc_sim <- spatstat.random::rpoispp(
        lambda = 761 / sf::st_area(pbc_win_sf),
        win=Window(pbc)
    )
    return(pbc_sim)
}
